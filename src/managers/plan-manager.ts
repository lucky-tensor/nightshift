...
export class PlanManager {
    ...
    async createPlan(
        ...
        logSuccess(`[Plan] ✓ Plan created with ${projects.length} projects`);
    ...
    markProjectCompleted(productId: string, projectId: string): void {
        ...
        if (allCompleted) {
            ...
            logSuccess(`[Plan] ✓ All projects completed! Product ready for review.`);
        } else {
            logSuccess(`[Plan] ✓ Project "${project.name}" completed`);
        }
    }
